...
class BorDAO(AbstractDAO, SingletonInstance):
    """
    Bill of Resources Data Access Object
    """
    ...
    def select_bor(self, session: AbstractSession, **params):
        """
        ...
        :return: {"columns" : columns, "data" : list}
        """
        return session.select("select * from FS_BOR", params)
