...
class BomDAO(AbstractDAO, SingletonInstance):
    """
    ...
    def select_bom_routing(self, session: AbstractSession, **params):
        """
        ...
        :return: {"columns" : columns, "data" : list}
        """
        return session.select("select * from MF_BOM_ROUTING", params)
